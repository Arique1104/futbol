...
class LeagueStatisticsTest < MiniTest::Test
  ...
  def setup
    game_path = './league_stats_fixtures/games_fixture.csv'
    team_path = './league_stats_fixtures/teams_fixture.csv'
    game_teams_path = './league_stats_fixtures/game_teams_fixture.csv'
  ...
  def test_it_exists_with_attributes
    ...
    assert_equal './league_stats_fixtures/games_fixture.csv', @stat_tracker.games
    assert_equal './league_stats_fixtures/teams_fixture.csv', @stat_tracker.teams
    assert_equal './league_stats_fixtures/game_teams_fixture.csv', @stat_tracker.game_teams
  end
